---
layout: post
title: Create a responsive background using Pseudo CSS
...
You've got yourself a beautiful new background image of your cat to lay text over but you can't get it to resize proportionally. Background size cover does a really weird zoom effect on large devices unless you upload an enormous image and setting the height and position on every breakpoint isn't terribly reliable.

e have an excellent tool to make scalable, responsive background images with CSS3 pseudo styles.
